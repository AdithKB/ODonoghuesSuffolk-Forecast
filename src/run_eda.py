...
from src.model import get_hour_shift
...
df['shift'] = df['hour'].apply(get_hour_shift)
...
sns.boxplot(data=df, x='anomaly_type', y='orders_count',
            order=['Normal Day', 'Aviva Event', "St. Patrick's Week"], palette='muted')
